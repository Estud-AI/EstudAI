    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 py-6 md:py-10">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 md:mb-8 gap-4">
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1 truncate">Flashcards - {subject.name}</h1>
          <p className="text-sm md:text-base text-gray-600">{flashcards.length} flashcard{flashcards.length !== 1 ? 's' : ''} disponível{flashcards.length !== 1 ? 'eis' : ''}</p>
        </div>
        <button 
          onClick={handleCreateFlashcards} 
        ...
        >
          {creating ? (
            ...
            <>
              ...
              <span className="hidden sm:inline">Gerar Mais</span>
