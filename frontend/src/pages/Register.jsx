...
import { register as registerUser, loginWithGoogle } from '../auth/auth';
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 backdrop-blur-sm border border-white/20">
          ...
          <div className="flex justify-center space-x-4">
            <button 
              ...
              className="flex items-center justify-center w-12 h-12 bg-gray-100 hover:bg-gray-200 rounded-full transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isGoogleLoading ? (
