    ...
    <div className="max-w-7xl mx-auto px-8 py-10">
      ...
      <div className="flex items-center justify-between mb-8 gap-6">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold text-gray-900 mb-1">Resumos - {subject.name}</h1>
          <p className="text-gray-600">{subject.summaries.length} resumo{subject.summaries.length !== 1 ? 's' : ''} disponível{subject.summaries.length !== 1 ? 'eis' : ''}</p>
        </div>
        <button 
          onClick={handleCreateSummary} 
